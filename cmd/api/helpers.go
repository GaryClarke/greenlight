...
func (app *application) readIDParam(r *http.Request) (int64, error) {
	...
	// or is less than 1, we know the ID is invalid
	id, err := strconv.ParseInt(params.ByName("id"), Base10, BitSize64)
	if err != nil || id < 1 {
...
func (app *application) writeJSON(w http.ResponseWriter, status int, data any, headers http.Header) error {
	...
	// Maybe change this back to js, err := json.Marshal(data) later
...
// The readQueryString() helper returns a string value from the query string, or the provided
