...
// User Define a User struct to represent an individual user. Importantly, notice how we are
...
// Set The Set() method calculates the bcrypt hash of a plaintext password, and stores both
...
// Matches The Matches() method checks whether the provided plaintext password matches the
...
func ValidatePasswordPlaintext(v *validator.Validator, password string) {
	...
	v.Check(len(password) <= 72, "password", "must not be greater than 72 bytes long")
}
