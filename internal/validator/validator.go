...
var (
	...
	//Foooooo = regexp.MustCompile("^[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+@[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:\\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)*$")
)
...
func Unique[T comparable](values []T) bool {
	seen := make(map[T]struct{}, len(values)) // Use `struct{}` for zero-size values
